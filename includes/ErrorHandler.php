<?php
    ...
    class ErrorHandler {
        ...
        public static function handleFatal(): void {
            ...
            prof_guardian_log( sprintf( '[Guardian] FATAL ERROR detected: %s in %s:%d', $error['message'], $error['file'], $error['line'] ) );
            ...
            if ( ! Helpers::shouldSendAlert( $hash, 3600 ) ) {
                prof_guardian_log( '[Guardian] Fatal error alert throttled (already sent within 1 hour)' );

                return;
            }

            prof_guardian_log( '[Guardian] Sending fatal error alert email...' );
